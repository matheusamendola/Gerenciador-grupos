 ...
 */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            if segue.identifier == "addPersonSegue" {
                if let destination = segue.destination as? addPersonViewController {
    ...
    @IBAction func sendGroup(_ sender: Any) {
        performSegue(withIdentifier: "sendGroupSegue", sender: nil)
    }
